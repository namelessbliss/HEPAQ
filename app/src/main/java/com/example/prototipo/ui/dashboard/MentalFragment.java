...
public class MentalFragment extends Fragment {
    ...
    private SpeedView estres, fantastico;
    ...
    private void setupActions() {
        ...
        estres.addSections(new Section(0f, .357142857f, getResources().getColor(R.color.speedview_amarillo), 40)
                , new Section(.357142857f, .67857142857f, getResources().getColor(R.color.speedview_verde), 40)
