...
public class ResponseAtenciones {
    ...
    @Expose
    public List<DiagnosticoObj> diagnosticoObj;
    @SerializedName("laboratorioObj")
    @Expose
    public LaboratorioObj laboratorioObj;
    @SerializedName("ecografiaObj")
    @Expose
    private EcografiaObj ecografiaObj;
    ...
    public EcografiaObj getEcografiaObj() {
        return ecografiaObj;
    }

    public void setEcografiaObj(EcografiaObj ecografiaObj) {
        this.ecografiaObj = ecografiaObj;
    }
}
